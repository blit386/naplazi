...
`pnpm run dev` runs the game on your own computer while you make it. To let other people play, you make a "production
...
- Made a change you want to share? Run `pnpm run build` again and re-upload `dist/`. The build does not update itself.
